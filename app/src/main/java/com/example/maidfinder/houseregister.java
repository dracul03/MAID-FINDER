...
public class houseregister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_houseregister);
        mregister = findViewById(R.id.houseregisterme);
        mgotosignin = findViewById(R.id.housebacktologin);
        mname = findViewById(R.id.housename);
        musername = findViewById(R.id.houseusername);
        mpassword = findViewById(R.id.housepassword);
        memail = findViewById(R.id.houseemail);
        mphone = findViewById(R.id.housephone);
        maddress = findViewById(R.id.houseaddress);
        maddress2 = findViewById(R.id.houseaddress2);



        mgotosignin.setOnClickListener((View.OnClickListener) view -> {
            Intent intent=new Intent(houseregister.this,houselogin.class);
    ...
    public void validateregistration(View view) {
        ...
        {return;
            ...
            reference = rootNode.getReference("houseUser");
