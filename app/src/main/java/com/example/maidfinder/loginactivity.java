...
public class loginactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        muserlogin=findViewById(R.id.profilewelcome);
        mpasslogin=findViewById(R.id.loginpass);

        mbacktologin.setOnClickListener((View.OnClickListener) view -> {
            Intent intent=new Intent(loginactivity.this,signup.class);
            startActivity(intent);
            finish();
        });
        mloginbutton.setOnClickListener((View.OnClickListener) view -> {
            logUser(view);
        });
